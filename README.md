...
* Новый алгоритм вычисления коэффициентов разбавления. Сочетает в себе преимущества
жадного алгоритма v2.5.x и алгоритма с накоплением промежуточных вычислений
более ранних версий.
